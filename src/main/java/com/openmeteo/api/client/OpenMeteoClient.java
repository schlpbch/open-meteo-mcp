package com.openmeteo.api.client;
...
public class OpenMeteoClient {
     ...
     */
    public Mono<com.openmeteo.api.client.models.SnowConditions> getSnowConditions(
            double latitude,
            double longitude,
            String hourlyParams,
            String dailyParams,
        ...
        return webClient.get()
                ...
                .retrieve()
                .bodyToMono(com.openmeteo.api.client.models.SnowConditions.class)
     ...
     */
    public Mono<com.openmeteo.api.client.models.SnowConditions> getSnowConditions(double latitude, double longitude) {
