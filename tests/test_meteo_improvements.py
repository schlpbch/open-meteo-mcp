...
from src.open_meteo_mcp.models import WeatherForecast, AirQualityForecast, GeocodingResponse, Location, CurrentWeather
...
class TestCountryFiltering:
    ...
    @pytest.mark.asyncio 
    async def test_country_filtering_no_matches_returns_all(self, mock_geocoding_response):
...
class TestTimezoneConsistency:
    ...
    async def test_timezone_consistency_across_endpoints(self):
        ...
        with patch.object(client.client, 'get') as mock_get:
            ...
            weather = await client.get_weather(46.9479, 7.4474, timezone="Europe/Zurich")
            air_quality = await client.get_air_quality(46.9479, 7.4474, timezone="Europe/Zurich")
...
class TestWeatherAlerts:
    ...
    def test_cold_alert_generation(self):
        ...
        assert alerts[0]["severity"] == "warning"  # -27°C feels like should trigger warning
