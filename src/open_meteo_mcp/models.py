...
class HourlyWeather(BaseModel):
    ...
    apparent_temperature: Optional[List[float]] = Field(None, description="Apparent temperature / feels like (°C)")
    precipitation: List[float] = Field(default_factory=list, description="Precipitation (mm)")
    precipitation_probability: Optional[List[int]] = Field(None, description="Precipitation probability (%)")
    ...
    wind_gusts_10m: Optional[List[float]] = Field(None, description="Wind gusts at 10m (km/h)")
...
class DailyWeather(BaseModel):
    ...
    precipitation_probability_max: Optional[List[int]] = Field(None, description="Maximum precipitation probability (%)")
    precipitation_hours: Optional[List[float]] = Field(None, description="Hours with precipitation")
    weather_code: List[int] = Field(default_factory=list, description="WMO weather codes")
    ...
    wind_speed_10m_max: Optional[List[float]] = Field(None, description="Maximum wind speed (km/h)")
    wind_gusts_10m_max: Optional[List[float]] = Field(None, description="Maximum wind gusts (km/h)")
...
class HourlySnow(BaseModel):
    ...
    apparent_temperature: Optional[List[float]] = Field(None, description="Apparent temperature / wind chill (°C)")
...
class GeocodingResult(BaseModel):
    ...
    admin2: Optional[str] = Field(None, description="Second-level administrative division")
    admin3: Optional[str] = Field(None, description="Third-level administrative division")
    admin4: Optional[str] = Field(None, description="Fourth-level administrative division")
...
class GeocodingResponse(BaseModel):
    ...
    generationtime_ms: Optional[float] = Field(None, description="API generation time in milliseconds")
...
class HourlyAirQuality(BaseModel):
    ...
    time: List[str] = Field(default_factory=list, description="Timestamps for each hour")
    european_aqi: Optional[List[int]] = Field(None, description="European Air Quality Index")
    us_aqi: Optional[List[int]] = Field(None, description="United States Air Quality Index")
    pm10: Optional[List[float]] = Field(None, description="Particulate matter PM10 (μg/m³)")
    pm2_5: Optional[List[float]] = Field(None, description="Particulate matter PM2.5 (μg/m³)")
    carbon_monoxide: Optional[List[float]] = Field(None, description="Carbon monoxide (μg/m³)")
    nitrogen_dioxide: Optional[List[float]] = Field(None, description="Nitrogen dioxide (μg/m³)")
    sulphur_dioxide: Optional[List[float]] = Field(None, description="Sulphur dioxide (μg/m³)")
    ozone: Optional[List[float]] = Field(None, description="Ozone (μg/m³)")
    dust: Optional[List[float]] = Field(None, description="Dust (μg/m³)")
    uv_index: Optional[List[float]] = Field(None, description="UV index")
    uv_index_clear_sky: Optional[List[float]] = Field(None, description="UV index under clear sky")
    ammonia: Optional[List[float]] = Field(None, description="Ammonia (μg/m³)")
    alder_pollen: Optional[List[float]] = Field(None, description="Alder pollen (grains/m³)")
    birch_pollen: Optional[List[float]] = Field(None, description="Birch pollen (grains/m³)")
    grass_pollen: Optional[List[float]] = Field(None, description="Grass pollen (grains/m³)")
    mugwort_pollen: Optional[List[float]] = Field(None, description="Mugwort pollen (grains/m³)")
    olive_pollen: Optional[List[float]] = Field(None, description="Olive pollen (grains/m³)")
    ragweed_pollen: Optional[List[float]] = Field(None, description="Ragweed pollen (grains/m³)")
...
class AirQualityForecast(BaseModel):
    ...
    timezone_abbreviation: Optional[str] = Field(None, description="Timezone abbreviation")
    utc_offset_seconds: Optional[int] = Field(None, description="UTC offset in seconds")
    current: Optional[CurrentAirQuality] = Field(None, description="Current air quality")
    hourly: Optional[HourlyAirQuality] = Field(None, description="Hourly air quality forecast")
